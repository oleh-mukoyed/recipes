...
export function CustomLink({
  ...
  const bg = "tg-button_text_color tg-button_color";
  /* switch (btnType) {
  ...
  const classes = clsx(
    "rounded-md px-4 py-1.5 inline-block text-lg font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
    bg,
    textColor,
    addClass
  );
